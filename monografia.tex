...
Agradeço ao meu orientador, Prof. Dr. Eduardo Morgado, por todo o tempo e trajetória no LTIA\footnote{Laboratório de Tecnologia da Informação Aplicada}, pela confiança, apoio e incentivo. Os quatro anos no LTIA foram essenciais para meu crescimento profissional e pessoal.

Agradeço a todos os professores, pois com muito esforço diário passaram não somente as informações técnicas e práticas de cada disciplina, mas lições que servirão para toda vida.

Agradeço a todos os colegas de curso, que de alguma forma auxiliaram a chegar ao último semestre da melhor maneira possível.

Agradeço aos meus amigos e familiares pelo apoio e incentivo na escolha e decorrer do curso, com muita compreensão e encorajamento.

Agradeço a Henrique Lopes Santos pela ajuda na realização das fotos e também criação do logotipo para o protótipo.

Agradeço a todos os colegas do LTIA pela incrível parceria, trabalho em equipe e organização de projetos.
\end{agradecimentos}
\fi
% ----------------------------------------------------------
